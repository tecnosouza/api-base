...
exports.getAll = async (query) => {
    const include = [];
    const pagination = await DataBaseService.dataFilter(Phone, query, include);
    ...
    return { data: phones.map(phone => new createResponseDTO(phone)), pagination: new PaginationDTO(pagination) };
};
